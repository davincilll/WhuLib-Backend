...
public abstract class AbstractProcessor {
    ...
    public HttpResponse convertAndGet(String url,Map<String,String> headers){
        return convertAndGet(Optional.empty(), url, headers, baseHeaders);
    }
    ...
    public HttpResponse convertAndGet(Object object, String url, Map<String, String> headers) {
        return convertAndGet(Optional.of(object), url, headers, baseHeaders);
    }
    ...
    private HttpResponse convertAndGet(Optional<Object> object, String url, Map<String, String> headers, Map<String, String> baseHeaders) {
        ...
        if (object.isPresent()){
            Map<String, Object> formData = mapper.convertValue(object.get(), new TypeReference<Map<String, Object>>() {
            });
    ...
    public HttpResponse convertAndPost(Object object, String url, Map<String, String> headers){
        return convertAndPost(object, url, headers, baseHeaders);
    }
